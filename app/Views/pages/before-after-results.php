...
.col-12 img {
  opacity: 0.9;
  cursor: pointer;
  /*margin: 2rem;*/ margin-bottom: 1rem;
  width: 100%;
}
...
.modal-dialog {
  ...
  <style>.shake{animation:shake-animation 3.72s ease infinite;transform-origin:50% 50%}@keyframes shake-animation {     0% {    transform:translate(0, 0)}
...
<div class="col-lg-12">
<h1 class="section-id blue-color">Hair Transplant Results</h1>
</div>
<div class="col-lg-8">
