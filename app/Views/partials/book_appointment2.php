<div class="sidebar-timetable sidebar-div mt-20 mb-50" style="background:#fff;" id="book_appointment_form2">
    <h5 class="h5-md mb-20 pad-20 text-center button-glow" style="color:#333;">BOOK APPOINTMENT</h5>				  
    <div class="col-lg-12">
        <!--<form method="POST">-->
        <form action="<?= site_url('submit_form_new') ?>" method="POST"  id="formRequestCallback2" name="formRequestCallback2">
