    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-10 offset-lg-1 section-title">
          <p class="what-our-client-say steelblue-color">What Our Patients Say</p>
          <div class="row">
            <div class="col-lg-8 offset-lg-2">
              <p class="text-mbold">There is no greater praise than the words that come from truly happy clients – our motivation to do better each day and offer higher standards of care!</p>
            </div>
          </div>
        </div>
      </div>
